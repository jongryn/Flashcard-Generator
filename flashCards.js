...
// These values represent thte text appearing on the front and the back of the created flash card.
exports.BasicCard = function(front, back) {
    this.front = front;
    this.back = back;
}

// ClozeCard constructor takes two argumetns: text and cloze.
